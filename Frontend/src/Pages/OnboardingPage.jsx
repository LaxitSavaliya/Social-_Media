...
const OnboardingPage = () => {
    ...
    const { isPending, onboardingMutation, error } = useOnboarding();
            ...
            <div className="min-h-screen flex items-center justify-center p-4 relative">
                ...
                <div className="w-full max-w-6xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                        ...
                        {/* LEFT SIDE */}
                        <div className="hidden lg:block text-white fade-in">
                            <div className="max-w-lg">
                                <h1 className="text-5xl font-bold mb-6 leading-tight">Welcome to Your
                                    <span className="bg-gradient-to-r from-yellow-300 to-pink-300 bg-clip-text text-transparent"> Journey</span>
                                </h1>
                                <p className="text-xl mb-8 opacity-90 leading-relaxed">
                                    Complete your profile to unlock personalized experiences, connect with amazing people, and
                                ...
                                <form className="space-y-4" onSubmit={handleSubmit} aria-label="Onboarding-Form">
                                    ...
                                    <div className="pt-2">
                                        <button type="submit" className="bg-[linear-gradient(135deg,#3b82f6_0%,#8b5cf6_100%)] shadow-[0_4px_15px_rgba(59,130,246,0.3)] transition-all duration-300 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)] hover:scale-101 active:scale-95 hover:shadow-[0_8px_25px_rgba(59,130,246,0.4)] w-full px-6 py-3 rounded-xl text-base relative text-white cursor-pointer font-semibold overflow-hidden group" disabled={isPending} aria-busy={isPending} aria-label="Submit">
                                            {isPending ? (
                                                <span className="loading loading-spinner loading-xs" aria-hidden="true">Submiting...</span>
                                            ) : (
                                                "Submit"
                                            )}
                                        </button>
