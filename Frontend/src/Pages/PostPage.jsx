...
const PostPage = () => {
    ...
    // Relevant likes without duplicates
                ...
                <div className="md:flex-1 flex flex-col border-t md:border-t-0 md:border-l border-gray-200">
                    ...
                    <div className="px-4 py-3 border-t border-gray-200">
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex space-x-4">
                                <motion.div whileTap={{ scale: 0.9 }}>
                                    <Heart aria-disabled={likePending} onClick={() => toggleLikeToPost(post?._id)} className={`w-6 h-6 cursor-pointer transition ${hasLiked ? "text-red-500" : "hover:text-gray-500"}`} fill={hasLiked ? "red" : "none"} />
                                </motion.div>
                        ...
                        >
                            ...
                            />
                            <button type="submit" className="text-blue-500 font-semibold text-sm hover:opacity-80">Post</button>
                        </form>
                    </div>
                </div>
            </motion.div>
